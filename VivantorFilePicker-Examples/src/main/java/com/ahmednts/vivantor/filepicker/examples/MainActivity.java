	...
	void PickupMediaFile()
	{
		...
		builder.setItems(items, new DialogInterface.OnClickListener()
		{
			...
			public void onClick(DialogInterface dialog, int item)
			{
				...
				{
					VFilePicker.getInstance().pick(VFilePicker.IMAGE).from(VFilePicker.GALLERY).saveTo("vFilePicker").show(MainActivity.this);
				}
				else if (items[item].equals("Camera"))
				{
					VFilePicker.getInstance().pick(VFilePicker.IMAGE).from(VFilePicker.CAMERA).saveTo("vFilePicker").show(MainActivity.this);
				}
